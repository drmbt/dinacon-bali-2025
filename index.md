...
<div class="project-card">
  <img src="{{ '/images/tex3d.jpg' | relative_url }}" alt="Texture Library" class="project-thumbnail">
...
<div class="project-card">
  <div class="thumbnail-grid">
    <img src="{{ '/images/SLH_ramp.jpg' | relative_url }}" alt="SLH Ramp">
    <img src="{{ '/images/tex-gradient.jpg' | relative_url }}" alt="Texture Gradient">
  </div>
...
<div class="project-card">
  <img src="{{ '/images/timelapse.jpg' | relative_url }}" alt="Time Lapse Bali" class="project-thumbnail">
...
<div class="project-card">
  <img src="{{ '/images/iNaturalist.jpg' | relative_url }}" alt="iNaturalist Image Selects" class="project-thumbnail">
...
<div class="project-card">
  <img src="{{ '/images/3d-model-from-single-image-AI.jpg' | relative_url }}" alt="3D Model From Single Image AI" class="project-thumbnail">
